...
#### [VPC](templates/vpc.yaml) OBSOLETE

  NOTE: VPC, subnets, routing etc are pre-created on your AWS account.
  Instead of this vpc-stack, you should supply VPC ID and (public) subnets for ALB
  and (private) subnets for ECS cluster as parameters to top-level stack.
